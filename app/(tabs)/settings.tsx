...
export default function SettingsScreen() {
  ...
  const handleManualSync = async () => {
    if (!isCloudSyncEnabled) {
      Toast.show({ type: 'info', text1: t('Cloud sync is disabled in offline mode') });
      return;
    }
  ...
  const handleSaveUser = async () => {
    ...
    if (formPin && !/^\d{6}$/.test(formPin.trim())) {
      Toast.show({ type: 'error', text1: t('PIN must be exactly 6 digits') });
      return;
    }
            ...
            <View style={styles.userInfo}>
              ...
              <View style={styles.userDetails}>
                ...
                <Text style={styles.userRole}>
                  {currentUser ? getRoleName(currentUser.roleId) : t('User')}
                </Text>
              </View>
            </View>
          ...
          <View style={styles.systemSection}>
            <View style={styles.systemCard}>
              <View style={styles.systemHeader}>
                ...
                <View style={styles.systemHeaderText}>
                  ...
                  {isCloudSyncEnabled ? (
                    ...
                    <Text style={styles.systemSubtitle}>
                      {t('Cloud sync is disabled in offline mode')}
                    </Text>
                  )}
                </View>
              </View>
              <Button
                ...
                disabled={isSyncing || !isCloudSyncEnabled}
              >
                {isCloudSyncEnabled ? (
                  isSyncing ? (
                  ...
                  <Text style={styles.systemButtonLabel}>{t('Sync disabled')}</Text>
                )}
              </Button>
            </View>
